  ...
  <div class="homeContent">
    <div class="home">
      <side class="sideBar">
        ...
        <form id="logout-form" action="{{ url('register') }}" method="POST" class="d-none">
            @csrf
        </form>
      ...
      @if(session()->has('Add'))
        ...
        @if(session()->has('import_error'))
				   <div class="alert alert-danger alert-dismissible fade show text-center" role="alert">
                      <strong>{{session()->get('import_error')}}</strong>
					  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
						  <span aria-hidden="true">&times;</span>
					  </button>
				   </div>
      ...
      <section class="AllDataContent">
        ...
        <form  action="{{ route('studentDatas.store')}}" method="post">
						  {{csrf_field()}}
              ...
              <div class="addHalaqt buttons">
                ...
                {{-- <div class="addMasaqBtn">
                <a class="masaqBtn text-white" style="text-decriton:none" href="{{URL('export_Student')}}">
                ...
                <div class="addMasaqBtn">
                    <a class="masaqBtn text-white"  href="{{URL('export_Student')}}">
        ...
        <table id="example" class="table table-borderd">
         ...
         <tbody>
						...
						<tr>
               <td title="الحلقة">{{$student->Name}}</td>
               <td title="المساق">{{$student->phone_number}}</td>
               <td title="البريد الاللكتروني">{{$student->email}}</td>
            </tr>
           @endforeach
          </tbody>
         </table>
